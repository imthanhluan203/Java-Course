...
public class SimpleWebSocketServer extends WebSocketServer {
    ...
    public void onOpen(WebSocket webSocket, ClientHandshake clientHandshake) {
        ...
        System.out.println("Connection Opened " + webSocket.getLocalSocketAddress());
        broadcastAllButSender(webSocket,"%s joined".formatted(name));
    }

    @Override
    public void onClose(WebSocket webSocket, int i, String s, boolean b) {
        System.out.println("Connection Closed " + webSocket.getLocalSocketAddress());
    ...
    private void broadcastAllButSender(WebSocket webSocket,String s){
        var connections = new ArrayList<>(getConnections());
        connections.remove(webSocket);
        broadcast(s,connections);

    }
    @Override
    public void onError(WebSocket webSocket, Exception e) {
        System.out.println("Error for " + webSocket.getLocalSocketAddress());
